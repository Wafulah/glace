...
export const SettingsForm: React.FC<SettingsFormProps> = ({
  ...
  const onSubmit = async (data: SettingsFormValues) => {
    try {
      setLoading(true);
      await axios.patch(`${process.env.NEXT_PUBLIC_API_ALL_URL}/stores/${params.storeId}/`, data, {
        headers: {
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`${process.env.NEXT_PUBLIC_API_ALL_URL}/stores/${params.storeId}/`, {
        headers: {
            'Authorization': `Bearer ${user?.jwt_token}`,
        },
    });
